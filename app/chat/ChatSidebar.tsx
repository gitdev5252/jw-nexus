...
const ChatSidebar: React.FC = () => {
    ...
    return (
        <aside className="w-full md:w-1/3 lg:w-1/4 border-r h-100% border-gray-300 overflow-y-auto p-[24px]">
            <div className="p-4 text-[24px]">
                Message
            </div>
            <div className='flex items-center border-[2px] border-gray-300 rounded-[20px] pl-[10px]'>
                <img src="/images/icons/magnifying-glass.svg" alt="Logo" className="w-[30px] h-[30px] rounded-full" />
                <input className='w-full h-[46px] pl-[10px] border-none focus:outline-none focus:border-none' placeholder='Search...' />
            </div>
            <div>
